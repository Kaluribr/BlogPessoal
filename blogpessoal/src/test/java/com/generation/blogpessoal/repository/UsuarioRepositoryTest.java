...
public class UsuarioRepositoryTest {
    ...
    public void deveRetornarUmUsiario() {
    ...
    public void deveRetornarTresUsiarios() {
    	
    	List<Usuario> lisitaDeUsuarios = usuarioRepository.findAllByNomeContainingIgnoreCase("Silva");
    	
    	assertEquals(3, lisitaDeUsuarios.size());
    	assertTrue(lisitaDeUsuarios.get(0).getNome().equals("João Da Silva"));
    	assertTrue(lisitaDeUsuarios.get(1).getNome().equals("Manuela da Silva"));
    	assertTrue(lisitaDeUsuarios.get(2).getNome().equals("Adriana da Silva"));
    }
